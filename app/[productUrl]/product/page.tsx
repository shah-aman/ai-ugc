...
const researchData: ConsolidatedResearch = {
  summary: {
    productSummary: {
      overview:
        "Comprehensive analysis of Meta Quest 3 VR headset with 128GB storage. Features Qualcomm Snapdragon XR2 Gen 2 processor, 2064x2208 pixels per eye resolution, new pancake lenses, and full-color mixed reality passthrough. Includes redesigned Touch Plus controllers with TruTouch haptics. 40% slimmer profile than Quest 2, with enhanced graphics performance and 8GB RAM. Supports both virtual reality and mixed reality experiences through its high-resolution color cameras. Released in October 2023 at $499.99.",
      keyInsights: [],
      marketOpportunity:
        "Estimated tens of millions of potential users globally",
      competitivePosition:
        "High-resolution color passthrough. Enhanced graphics performance with Snapdragon XR2 Gen 2. Slimmer design for comfort. Affordable price point",
      valueProposition:
        "Supports both virtual reality (VR) and mixed reality (MR) experiences. High-resolution display for immersive experiences. Redesigned Touch Plus controllers with enhanced haptics. Enhanced audio capabilities with spatial sound support",
    },
    detailedAnalysis: {
      features: {
        features: [
          {
            ...
            description:
              "Supports both virtual reality (VR) and mixed reality (MR) experiences",
            technicalDetails: [
          ...
          },
          {
            name: "Controllers",
            description:
              "Redesigned Touch Plus controllers with enhanced haptics",
            technicalDetails: ["TruTouch haptics", "Improved ergonomics"],
          },
          {
            name: "Audio and Sound",
            description:
              "Enhanced audio capabilities with spatial sound support",
            technicalDetails: ["3D spatial audio", "40% louder than Quest 2"],
          },
        ],
        specifications: {
        ...
        buildQuality: {
          materials: ["Plastic", "Adjustable headband"],
          durability: "Robust construction with a 1-year limited warranty",
        },
      },
      market: {
        primaryMarket: {
          demographics: ["Young adults", "Gamers", "Tech-savvy individuals"],
          psychographics: [
        ...
        secondaryMarkets: [
          {
            ...
            opportunity:
              "Utilizing VR for interactive learning experiences and professional development",
          },
          {
            segment: "Healthcare and Therapy",
            opportunity:
              "Employing VR for therapy, treatment, and patient education",
          },
          {
            segment: "Enterprise and Business",
            opportunity:
              "Enhancing collaboration, training, and customer engagement",
          },
        ],
        userPersonas: [
          {
            ...
            description:
              "Individuals who frequently play video games and seek immersive experiences",
            needs: [
          ...
          },
          {
            type: "Tech Explorer",
            description:
              "Early adopters interested in exploring new technologies and experiences",
            needs: ["Innovative features", "Ease of use", "Affordability"],
          },
          {
      ...
      competition: {
        directCompetitors: [
          ...
          },
          {
            ...
            weaknesses: ["Higher price point", "Limited consumer appeal"],
            pricePoint: "$1,000",
          },
          {
            name: "HTC Vive Pro 2",
        ...
        painPoints: [
          {
            ...
            effectiveness:
              "Highly effective in improving user comfort during extended VR sessions.",
            userFeedback:
              "Users appreciate the slimmer design, finding it more comfortable to wear.",
          },
          {
            ...
            effectiveness:
              "Significantly enhances the VR experience with improved graphics.",
            userFeedback:
              "Customers report a noticeable improvement in graphics quality and performance.",
          },
          {
            ...
            effectiveness:
              "Meets the storage requirements of most users, though some may still find the base model limiting.",
            userFeedback:
              "Users appreciate the flexibility in storage options, though some prefer larger capacities.",
          },
          {
            ...
            effectiveness:
              "Effectively supports mixed reality applications with improved color accuracy.",
            userFeedback:
              "Users enjoy the immersive mixed reality experiences, though some find hand tracking could be improved.",
          },
          {
            ...
            effectiveness:
              "Somewhat effective, as users still report needing frequent recharges.",
            userFeedback:
              "Customers find the battery life insufficient for extended gaming sessions.",
          },
        ],
        satisfactionMetrics: {
          overallRating: "4.5/5",
        ...
        improvementAreas: [
          {
            area: "Battery Life",
            suggestion:
              "Enhance battery life to support longer VR sessions without recharging.",
          },
          {
            area: "Hand Tracking",
            suggestion:
              "Improve hand tracking capabilities for more intuitive interactions.",
          },
          {
            area: "Storage Options",
            suggestion:
              "Consider offering larger storage options or expandable storage solutions.",
          },
        ],
      },
    },
          ...
          <div className="flex flex-col gap-6 p-6 w-full">
            ...
            >
              {methods.switch({
                ...
                "market-strategy": () => (
                  <MarketStrategyView researchData={researchData} />
                ),
